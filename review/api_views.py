...
''''
Below 2 examples are done using functional
based view, You can follow any of the coding style
...
class Login(APIView):
    def post(self,request):
        ...
        if not user:
            return Response({'error':'Credentials are incorrect or the user account does not exists'},status=HTTP_404_NOT_FOUND)
        else:
