...
from review.models import Publisher, Contributor, Book, BookContributor, Review


class Command(BaseCommand):
    help = 'Load the review data from a CSV file.'
    ...
    def handle(self, *args, **options):
        ...
        for data_dict in models.get('Contributor', []):
            c, created = Contributor.objects.get_or_create(first_names=data_dict['contributor_first_name'],
                                                           last_names=data_dict['contributor_last_name'],
